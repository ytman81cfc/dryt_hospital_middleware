...
import com.hospital.middleware.hospitalinfection.dao.his.JD003DAO;
...
@Service
public class Service_JD003 extends BaseService implements IService {
    @Autowired
    private JD003DAO JD003;

    @Override
    public List<Map> queryData(Map paramMap) {
        return JD003.queryData(paramMap);
    }
