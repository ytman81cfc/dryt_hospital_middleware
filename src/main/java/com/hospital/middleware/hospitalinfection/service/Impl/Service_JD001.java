...
import com.hospital.middleware.hospitalinfection.dao.his.JD001DAO;
...
@Service
public class Service_JD001 extends BaseService implements IService {
    @Autowired
    private JD001DAO JD001;

    @Override
    public List<Map> queryData(Map paramMap) {
        return JD001.queryData(paramMap);
    }
