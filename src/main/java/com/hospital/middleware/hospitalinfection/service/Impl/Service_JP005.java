...
import com.hospital.middleware.hospitalinfection.dao.his.JP005DAO;
...
@Service
public class Service_JP005 extends BaseService implements IService {
    @Autowired
    private JP005DAO jp005;

    @Override
    public List<Map> queryData(Map paramMap) {
        return jp005.queryData(paramMap);
    }
